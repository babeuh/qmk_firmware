...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT(
        ...
        KC_LABK, KC_SCLN, KC_LCBR, KC_LPRN, KC_LBRC,    KC_HASH, KC_MINS, KC_BSLS, KC_QUOT, KC_DLR,
        KC_RABK, KC_COLN, KC_RCBR, KC_RPRN, KC_RBRC,    KC_AMPR, KC_TILD, KC_NO,   KC_GRV,  KC_NO,
